      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
			 <ul class="nav navbar-nav navbar-right">
				...
				<li class="active"><a href="counselor.html">High School Counselor</a></li>
				...
				<li><button type="button" class="btn btn-success" id="menu-but"><a href="Register.html">Sign up</a></button></li>
			  </ul>	  
        </div><!--/.navbar-collapse -->
      </div>
    </div>
