            ...
            <div class="page-content inset">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form method="post" onsubmit="infoModal('password')" id="change-password-form" method="post" action="/student/{{ $data['student']->id }}"><input type="hidden" name="_method" value = "put"/>
                            <div class="row">
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="icon-append fa fa-lock"></i></span>
                                         <input type="password" name="old_password" id="old_password" class="form-control input-sm" placeholder="Current Password">
                                    </div>
                                </div>
                            </div>
                            <hr>
