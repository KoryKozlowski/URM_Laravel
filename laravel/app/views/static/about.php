  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="/index"><img src="img/logo_2.png"><font color="#fcb040"> University Recruit Me</font></a>
        </div>
    ...
    <!-- Main jumbotron for a primary marketing message or call to action -->
     <div class="row col-xs-6">
          <p><center><h3><br><br>UniversityRecruitMe is your innovative, cutting-edge online resource for students during their high school journey.UniversityRecruitMe is the forerunner of online forums for the next generation of college applicants. URM allows high school students the ability to promote themselves by communicating their experiences and achievements with their favorite Universities. This will also allow college admissions counselors access to a more complete applicant profile.</h3></center></p>
      </div>

   <!-- <div class="jumbotron col-xs-6">-->
      <div class="container col-xs-6">
        <h1><center><img src="img/URM_Logo.png" width="599" height="339" ></center></h1>
        <h2><center><img src="img/u3849-4.png"></center></h2>
      </div>
    </div>
