  ...
  <a class="right carousel-control" href="#imageCarousel" data-slide="next">
    ...
    <div class="jumbotron col-xs-6">
      <div class="container">
        ...
        <p>Each year, many high school students are not given the opportunity to excel in college, because they are judged merely on grades and enrollment figures. These students are further disadvantaged, because the recruitment process has changed considerably due to many schools’ budgets being diminished in recent years. The landscape of recruiting students to institutions of higher education has changed, and more schools are seeking to learn as much as possible about the students they are recruiting. UniversityRecruitMe will allow high school students to create a professional profile, in which they can present themselves to interested universities! So sign up today to Enhance your Future….<h2><center>NOW!</center></h2>
</p>
      </div>
    </div>
